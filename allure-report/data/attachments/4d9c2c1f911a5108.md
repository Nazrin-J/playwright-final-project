...
> 28  |     await this.page.goto('https://www.demoblaze.com/')
  ...
  77  | }
  78  | async details(name,country,city,creditcard,month,year,purchase)
  79  | {
  80  | 
  81  | 
  82  |     await this.name.fill(name)
  83  |     await this.country.fill(country)
  84  |     await this.city.fill(country)
  85  |     await this.creditcard.fill(country)
  86  |     await this.month.fill(country)
  87  |     await this.year.fill(country)
  88  |     await this.purchase.fill(country)
  89  | 
  90  | }
