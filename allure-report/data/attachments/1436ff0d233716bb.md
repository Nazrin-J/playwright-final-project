...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//a[@onclick='byCat('phone')']' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//a[@onclick=\'byCat(\'phone\')\']')
