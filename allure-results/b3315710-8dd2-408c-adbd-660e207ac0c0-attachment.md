...
```
Error: locator.click: Error: strict mode violation: locator('#tbodyid a[href="prod.html?idp_=1"]') resolved to 2 elements:
...
Call log:
  - waiting for locator('#tbodyid a[href="prod.html?idp_=1"]')
