...
Call log:
  - waiting for locator('.card-title a').filter({ hasText: 'ASUS Full HD' })
...
```ts
  ...
  21 | this.purchase=page.getByRole('button', {name:'Purchase'})
  ...
  49 | }
  50 | 
  51 | async productundermonitors()
  52 | {
  53 |     await this.monitors.click()
  54 | 
  55 | } 
  56 | 
  57 | async selectmonitor()
  58 | {
> 59 |     await this.asus.click()
     |                     ^ Error: locator.click: Target page, context or browser has been closed
  60 | 
  61 | }
