...
```
TypeError: login.signupconfirm is not a function
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: testdemoproj
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox [active] [ref=e15]: testdemoproj@123
        - generic [ref=e17]:
...
```ts
  ...
  5  | const login=new Loginvalid(page)  //constructor invoking
  6  | await login.loginurl()
  7  | await login.loginbutton()
  8  | await login.validlogincred('testdemoproj','testdemoproj@123')
> 9  | await login.signupconfirm()
     |             ^ TypeError: login.signupconfirm is not a function
  10 | })
```