...
```
Error: locator.click: Error: strict mode violation: locator('.btn.btn-secondary') resolved to 4 elements:
...
Call log:
  - waiting for locator('.btn.btn-secondary')
...
```ts
  ...
  9  | this.closebutton=page.locator('.btn.btn-secondary')
  10 | 
  11 | 
  12 | 
  13 | }
